...
function figure2_jaynes_cummings(; save_path = nothing)
    ...
    lines!(
        ...
        linewidth = 2.5,
        linestyle = :dash,
        label = L"\mathrm{SW order 2: } -g^2/\Delta",
    )
    lines!(
        ax1,
        g_range,
    ...
    lines!(
        ...
        linewidth = 1.5,
        linestyle = :dot,
        label = L"\mathrm{Leading order: } -g^2",
    )
    ...
    lines!(
        ax2,
        g_range,
        zeros(length(g_range)),
        color = COLORS[1],
        linewidth = 2.5,
        linestyle = :dash,
        label = L"\mathrm{SW order 2: } K = 0",
    )
    lines!(
        ax2,
        g_range,
        ...
        linewidth = 2.5,
        linestyle = :solid,
        label = L"\mathrm{SW order 4: } K = \frac{4g^4}{3\Delta^3}",
    )
...
function figure4_rabi_bloch_siegert(; save_path = nothing)
    ...
    lines!(
        ...
        linewidth = 2.5,
        linestyle = :dash,
        label = L"\mathrm{Full Rabi: } \chi \approx -g^2/\Delta - g^2/(\Delta + 2\omega)",
    )
